...
--- результат поиска
SELECT fulladdress, fts, for_nominatim 
from search where fts @@ websearch_to_tsquery('address','адыгея чкалова 65'
...
CREATE TRIGGER add_to_search2 AFTER INSERT ON gar_item_adm
